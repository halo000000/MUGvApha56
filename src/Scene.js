...
export class Scene extends Phaser.Scene {
    ...
    create() {
        ...
        // let foods = new  Foods(undefined, this);
        // foods.load()
        // foods.pickUp()
    ...
    loadTower() {
        // this.tower = this.physics.add.sprite(932, 800, 'towerPlce');
        ...
        // this.anims.create({
        //     key: "towerPlce",
        //     frames: this.anims.generateFrameNumbers("towerPlce"),
        //     frameRate: 8,
        //     repeat: -1
        // });

        // this.tower.play('tower');
